...
<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
    ...
    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion">
            ...
            <div class="menu-item">
                <a class="menu-link active" href="{{ route('layananMasyarakat') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <form class="row g-3">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <input type="text" class="form-control" id="inputAddress" aria-describedby="alasan"
                                ...
                                <h3 class="card-title align-items-start flex-column mb-3">
                                    <span class="card-label fw-bolder fs-3 mb-1">Layanan Masayarakat</span>
                                </h3>
                                <form class="row g-3">
                                    <div class="col-md-12 mb-4">
                                        <input type="text" class="form-control" id="inputAddress" aria-describedby="alasan"
